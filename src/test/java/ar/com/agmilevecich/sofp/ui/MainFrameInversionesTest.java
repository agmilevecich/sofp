...
class MainFrameInversionesTest {
    ...
    @Test
    void deberiaMostrarLasInversionesDelPerfilAlNavegarDesdeMainFrame() throws Exception {
        ...
        SwingUtilities.invokeAndWait(() -> {
            JButton botonInversiones = buscarBoton(
                    mainFrame.getContentPane(),
                    "Inversiones"
            );
            assertNotNull(botonInversiones);
    ...
    private Contexto crearContexto(Moneda moneda) {
        Usuario usuario = new Usuario(
                "Ariel",
                "Test",
                "ariel.mainframe.inversiones." + System.nanoTime(),
                "hash"
        );
