...
class MonedaTest {
    ...
    void deberiaCrearMonedaCrypto() {
        Moneda moneda = new Moneda("BTC", "Bitcoin", 8, TipoMoneda.CRYPTO);
    ...
    void deberiaCambiarNombre() {
        Moneda moneda = new Moneda("USD", "Dolar", 2, TipoMoneda.FIAT);
    ...
    void deberiaCambiarCantidadDecimales() {
        ...
        assertEquals(6, moneda.getCantidadDecimales());
    }
    ...
    @Test
    void noDeberiaPermitirCantidadDecimalesNegativaAlCrear() {
        assertThrows(
                IllegalArgumentException.class,
                () -> new Moneda("ARS", "Peso argentino", -1, TipoMoneda.FIAT)
        );
    }

    @Test
    void noDeberiaPermitirCantidadDecimalesNegativaAlModificar() {
        Moneda moneda = new Moneda("ARS", "Peso argentino", 2, TipoMoneda.FIAT);

        assertThrows(
                IllegalArgumentException.class,
                () -> moneda.cambiarCantidadDecimales(-1)
        );
    }
}
